...
compile: gmc.hs BuildGlobal.hs GGparser.hs SystemParser.hs PomsetSemantics.hs sgg.hs sysparser.hs minimise.hs gg2fsa.hs gg2pom.hs minimise.hs gg2pom.hs gg2fsa.hs gg2gml.hs #K KGparser.hs hgsem.hs
	$(MAKE) all
